...
public class CameraController : MonoBehaviour {
    ...
    void Start() {
        ...
        panoramaCapture = GameObject.Find("Panorama Capture Controller").GetComponent<PanoramaCapture>();
        ...
        if (cameras.Length > 0) {
            ...
            panoramaCapture.targetCam = cameras[0];
    ...
    void Update() {
        ...
        if (Input.GetKeyDown(KeyCode.C)) {
            ...
            if (currCamIndex < cameras.Length) {
                ...
                currCamIndex = 0;
                cameras[currCamIndex].gameObject.SetActive(true);
                panoramaCapture.targetCam = cameras[currCamIndex];
                Debug.Log("Camera with name: " + cameras[currCamIndex].name + ", is now enabled");
            }
        }
    }
